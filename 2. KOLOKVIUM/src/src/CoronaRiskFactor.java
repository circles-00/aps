...
public class CoronaRiskFactor {
    public static void main(String[] args) throws NumberFormatException, IOException {
        ...
        //
        CBHT<String, String> positive = new CBHT<>(2 * N);
        CBHT<String, String> negative = new CBHT<>(2 * N);
        ...
        //broenje pozitivni pacienti
        int positiveCounter = 0;
        if(positive.search(opstina) != null){
            SLLNode<MapEntry<String, String>> curr = positive.search(opstina);
            while(curr != null){
                positiveCounter++;
                curr = curr.succ;
            }
        ...
        if(negative.search(opstina) != null){
            SLLNode<MapEntry<String, String>> curr = negative.search(opstina);
            while(curr != null){
                negativeCounter++;
                curr = curr.succ;
            }
        ...
        float riskFactor =  (float) positiveCounter / (negativeCounter + positiveCounter);
