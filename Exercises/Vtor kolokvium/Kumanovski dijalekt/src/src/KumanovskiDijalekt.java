...
public class KumanovskiDijalekt {
    public static void main (String[] args) throws IOException {
        ...
        CBHT<String, String> mapa = new CBHT<>(77);

        for(int i=0;i<N;i++){
            String rechnik=br.readLine();
            String [] split = rechnik.split(" ");
            mapa.insert(split[0], split[1]);
        }
        ...
        for(int i=0; i < split.length; i++){
            ...
            if(mapa.search(word) != null) {
                newWord = mapa.search(word).element.value;
